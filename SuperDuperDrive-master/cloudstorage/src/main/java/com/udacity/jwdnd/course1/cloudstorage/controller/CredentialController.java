...
public class CredentialController {
    ...
    public String getHomePage(
        ...
        model.addAttribute("credentials", this.credentialService.getCredentialListings(user.getUser_Id()));
    ...
    public String newCredential(
        ...
        User user = userService.getUser(userName);
        model.addAttribute("credentials", credentialService.getCredentialListings(user.getUser_Id()));
        model.addAttribute("encryptionService", encryptionService);
